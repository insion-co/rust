...
[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=Insion%2FRust)
[![crates.io shield](https://img.shields.io/crates/v/insion)](https://crates.io/crates/insion)

The Insion Rust library provides convenient access to the Insion APIs from Rust.
...
```rust
match client.moderate_a_record(None)?.await {
    Ok(response) => {
...
```rust
let response = client.moderate_a_record(
