...
pub enum RecordModerationStatus {
    Compliant,
    Flagged,
...
impl Serialize for RecordModerationStatus {
...
impl<'de> Deserialize<'de> for RecordModerationStatus {
...
impl fmt::Display for RecordModerationStatus {
