...
pub enum ModerateResponseStatus {
    Compliant,
    Flagged,
...
impl Serialize for ModerateResponseStatus {
...
impl<'de> Deserialize<'de> for ModerateResponseStatus {
...
impl fmt::Display for ModerateResponseStatus {
